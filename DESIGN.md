...
### 4.3 시크릿 관리
- API 키는 GitHub Actions Secrets로 관리
- 저장소에 평문 저장 금지
...
### 10.1 GitHub Actions → GitHub Pages
- Actions에서 데이터 생성
- Pages 전용 브랜치에 JSON 파일 덮어쓰기
